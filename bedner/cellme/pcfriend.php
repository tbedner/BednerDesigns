...
?>
    ...
    <p>
    Have an email sent to your friends inviting them to join CellMe from your email service provider by entering your username and password below. This information is not stored anywhere and is removed when you close your browser.<br /><br />
...
if (!$done)
	...
	if ($step=='get_contacts')
		...
		$contents.="</select></td></tr>
			<tr class='thTableImportantRow'><td colspan='2' align='center'><input id='mysubmit' type='submit' name='import' value='Import Contacts'></td></tr>
