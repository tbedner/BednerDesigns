...
function mobile_device_detect($iphone='http://cellme.mobi/id/id.php',$android='http://cellme.mobi/id/id.php',$opera=true,$blackberry=true,$palm=true,$windows=true,$mobileredirect=false,$desktopredirect=false){
