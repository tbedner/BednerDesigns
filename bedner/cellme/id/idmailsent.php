...
// echo data 
if ($status == 'unread') {
echo '<li class="mail"><br /><a href="idsentmail.php?msg='.$msgid.'"><img src="../'.$photo.'" border="0" height="56" width="51" align="absmiddle" /></a><br /><a href="idsentmail.php?msg='.$msgid.'"><b><i><font size="2" color="#7FB0B0">'.$fname.' '.$lname.'</font></i></b></a><br /><a href="idsentmail.php?msg='.$msgid.'"><b><i>'.$sub.'<br /><font size="1" color="#7FB0B0">'.$emaildate.'</font></i></b></a><br /><br /><br /><a href="idsentmaildelete.php?msg='.$msgid.'">Delete Sent Message</a><br /><br /></li>';  
}  
else{
// echo data
echo '<li class="mail"><br /><a href="idsentmail.php?msg='.$msgid.'"><img src="../'.$photo.'" border="0" height="56" width="51" align="absmiddle" /></a><br /><a href="idsentmail.php?msg='.$msgid.'"><font size="2" color="#7FB0B0">'.$fname.' '.$lname.'</font></a><br /><a href="idsentmail.php?msg='.$msgid.'">'.$sub.'<br /><font size="1" color="#7FB0B0">'.$emaildate.'</font></a><br /><br /><br /><a href="idsentmaildelete.php?msg='.$msgid.'">Delete Sent Message</a><br /><br /></li>';  
}    
} // end while
}
else{
