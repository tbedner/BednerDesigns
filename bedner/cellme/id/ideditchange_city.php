...
<?php
idcheck_valid_user2();
if ($sent == 'true') { echo '<br /><center><font size="3" color="#F000F0">City changed</font><br /></center>';}
if ($sent == 'false') { echo '<br /><center><font size="3" color="#F000F0">Problem - City Not Changed<br />Please check your information and try again</font><br /></center>';}


?>
<hr />City<br /><hr />
<form action="ideditchange_city2.php" method="post">
Old City/State - <?php echo $old_city; ?></font></td>
<li class="form"><input placeholder="New City/State" name="new_city" type="text" maxlength="100" /></li>
<li class="form"><input id="mysubmit" type="submit" value="Change City" /></li>
</form>
