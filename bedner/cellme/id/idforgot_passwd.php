...
<div id="topbar"> <img alt="logo" src="images/logo.jpg" />
	<div id="title"> 
		 cellme</div>  
	<div id="leftnav"><a href="id.php"><img alt="home" src="images/home.png" /></a></div><div id="rightnav"><a href="idjoin.php">Join</a></div>
</div> 
<div id="content"> 
	<ul class="pageitem"> 
...
<?php
  ...
  try {
    ...
    echo 'Your password could not be reset - please try again later or contact us using the form above.<br /><br />';
  }
?>
</li><span class="name2">
