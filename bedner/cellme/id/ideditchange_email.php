...
<?php
idcheck_valid_user2();
if ($sent == 'true') { echo '<br /><center><font size="3" color="#F000F0">Email changed</font><br /></center>';}
if ($sent == 'false') { echo '<br /><center><font size="3" color="#F000F0">Problem - Email Not Changed<br />Please check your information and try again</font><br /></center>';}


?>
<hr />Email<br /><hr />
<form action="ideditchange_email2.php" method="post">
Old Email - <?php echo $old_email; ?>
