...
<?php echo '<a href="pcsentmaildelete.php?msg='.$msgid.'">Delete</a>&nbsp;&nbsp;&nbsp;&nbsp;'; ?>
<a href="pcmailsent.php">Sent</a>&nbsp;&nbsp;&nbsp;&nbsp; 
</div><br /><br /> 
<table id="emailview" width="550px" align="left">

<tr rowspan="2"><td><i>Sent to:</i><br /><?php echo $fname.' '.$lname; ?><br /><font size="1" color="#7FB0B0"><?php echo $emaildate; ?></font><br /><br /></td><td><?php echo $sub; ?><br /><br /></td></tr>
