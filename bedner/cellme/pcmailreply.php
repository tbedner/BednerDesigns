...
<tr><td><br /><?php echo'<img src="'.$photo.'" border="0" height="56" width="51" />';?> <br /><br /></td><td>
     <form action="pcmailreply2.php" method="post">
     <br />
     &nbsp;To: <?php echo $fname.' '.$lname; ?>
     <br /><br />
     &nbsp;Subject: <input type="text" name="subject" size="50" />
      <br /><br />
    &nbsp;<textarea id="mail" name="mail" rows="10" cols="65" wrap="virtual" />
